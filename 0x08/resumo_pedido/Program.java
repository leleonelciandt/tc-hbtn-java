...
public class Program {
    public static void main(String[] args) {
        ...
        System.out.printf("%s - %s\n", pedido1.getFrete().getTipoProvedorFrete(), convertToDouble(pedido1.getFrete().getValor()));
        ...
        System.out.printf("%s - %s\n", pedido2.getFrete().getTipoProvedorFrete(), convertToDouble(pedido2.getFrete().getValor()));
        ...
        System.out.printf("%s - %s\n", pedido3.getFrete().getTipoProvedorFrete(), convertToDouble(pedido3.getFrete().getValor()));
        ...
        System.out.printf("%s - %s\n", pedido4.getFrete().getTipoProvedorFrete(), convertToDouble(pedido4.getFrete().getValor()));
        ...
        public static String convertToDouble(double valor) {
