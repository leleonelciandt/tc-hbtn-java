...
public class ConsultaPessoas {
    ...
    public static Map<String, TreeSet<String>> obterHobbiesPorCargo(List<Pessoa> listPessoas){
        return listPessoas.stream().collect(Collectors.groupingBy(Pessoa::getCargo, Collectors.flatMapping(pessoa -> pessoa.getHobbies().stream(), Collectors.toCollection(TreeSet::new))));
    }
